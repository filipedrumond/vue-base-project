...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var self = this; // this.teste = "n testei"
    // this.$http.get('http://localhost:3000/tabela').then(response => {
  ...
  methods: {
    save: function save(e) {
      e.preventDefault();
      var self = this;
      this.$http.post('http://localhost:3000/tabela', self.endereco).then(function (response) {
        alert("salvo");
      ...
      _c("form", { attrs: { action: "" }, on: { submit: _vm.save } }, [
        ...
        _c("div", [
          ...
          _c("input", {
            ...
            attrs: { type: "text" },
            domProps: { value: _vm.endereco.cidade },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.config.productionTip = false; // Vue.use(VueSession);
...
window.Vue = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  template: '<App/>',
  created: function created() {// this.$session.start();
  }
});
...
module.exports = __webpack_require__(/*! C:\Users\Filipe Drumond\Desktop\PROJETAO_MED\src\index.js */"./src/index.js");
